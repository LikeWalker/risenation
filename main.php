		...
		<section class="intro">
			<div class="wrapper__intro">
				...
				<div class="intro__img">
					<img src="img/100.png" class="img__intro">
				</div>
			</div>
		</section>
	<!-- intro end -->
			...
			<div class="service__cards">
				<div class="service__card">
					<div class="service__card__pic">
						...
						<p class="service__card__desc">
							Девять новых автобусов вышли на пригородные маршруты Якутска
						</p>
					</div>
				</div>
				<div class="service__card">
					<div class="service__card__pic">
						...
						<p class="service__card__desc">
							Ысыах в Ленском районе Якутии пройдет в традиционном формате
						</p>
					</div>
				</div>
				<div class="service__card">
					<div class="service__card__pic">
						...
						<p class="service__card__desc">
							Ледоход на реке Лене продвинулся на 62 км за сутки
						</p>
					</div>
				</div>
			</div>
